...
<header class="container mt-3 mb-5">
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            <a class="navbar-brand logo-text fs-1" href="#"><i class="fa-solid fa-coins logo-icon text-success"></i> FinPlus</a>
        ...
        <div class="col-sm-6 mb-3 mb-sm-0">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text"></p>
                    <a href="#" class="btn btn-success bg-color">Recentes</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-6 mb-3 mb-sm-0">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-text"></p>
                    <a href="#" class="btn btn-success bg-color">Aplicações Recentes</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-4 mb-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-success bg-color" data-bs-toggle="modal"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" class="btn btn-success bg-color"
