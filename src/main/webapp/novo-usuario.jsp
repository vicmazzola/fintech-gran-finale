      ...
      <div class="card-body">
        <form action="login.jsp" method="post">
          ...
          <div class="form-group">
            ...
            <div class="form-group">
              <label for="id-confirmar-senha">Confirmar Senha</label>
              <input type="password" name="confirmar_senha" id="id-confirmar-senha" class="form-control" required>
            </div>
          ...
          <input type="submit" value="Criar Conta" class="btn btn-success mt-3">
        </form>
      </div>
    </div>
  </div>
